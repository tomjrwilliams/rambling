...
here we do reversion, but within sectors
ie. reverse trend singe, but sorting is all within sector


vs the sectors where we construct baskets of sectors (ie. one hot factor portfolios)
