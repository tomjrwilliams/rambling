...
If using this in production, one would probably want to also include some kind of [covariance shrinkage](../pca_equity_shrunk/index.qmd).
...
See [here](../pca_equity_shrunk/index.qmd) for a more production-ready example, also encorporating Ledoit-Wolf covariance shrinkage.